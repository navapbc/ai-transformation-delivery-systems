...
```
gh api "repos/navapbc/ai-transformation-delivery-systems/contents/testing/classifier/AGENT_INSTALL.md?ref=<sha>" --jq .content | base64 -d
```
...
```
gh api "repos/navapbc/ai-transformation-delivery-systems/contents/<path>?ref=<sha>" --jq .content | base64 -d
```
